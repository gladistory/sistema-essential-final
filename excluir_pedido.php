...
$obpedidoID = novoPedido::getPedido($_GET['id']);

//Validar se a vaga existe no banco

if (!$obpedidoID instanceof novoPedido) {
    header('location: pedidos.php?status=error');
    exit;
}
...
if (isset($_POST['excluir'])) {
    $obpedidoID->excluir();
    header('location: pedidos.php?status=succes');
    exit;
}
        ...
        <form method="post">
            <div class="form-group">
                ...
                <div class="card text-center container-sm">
                    <div class="card-body">
                        <h5 class="card-text">Clique para excluir o pedido.</h5>
